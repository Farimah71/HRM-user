...
import { getDataFromSessionStorage } from "../../../helpers/get-data-from-session";
// ++++++++++ images import ++++++++++
...
export const UserProfile = ({ userName, role }) => {
  ...
  useEffect(() => {
    setUserInfo({
      fullName: getDataFromSessionStorage("userFullTitle"),
  ...
  // ---------- render jsx ----------
  return (
    <div className="flex items-center gap-x-2 pb-4 px-4 border-b border-custom-gray-light">
      <ProfileMenu
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between">
          <h4 className="text-16 text-custom-dark font-semibold">
            {userInfo.fullName}
          </h4>
        ...
        <span className="text-14 text-custom-gray-muted">Employee</span>
      </div>
    </div>
  );
};
